                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 p-8">
                        <div class="text-center mb-8">
                            <h2 class="text-3xl font-bold text-white mb-2">{{ __('auth.forgot_password') }}</h2>
                            <p class="text-blue-100">{{ __('auth.forgot_password_description') }}</p>
                        </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            >
                                <span v-if="!form.processing">{{ __('auth.send_reset_link') }}</span>
