<template>
    ...
    <AdminLayoutSidebar>
        ...
        <div v-if="showCreateTemplateModal || showEditTemplateModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" dir="rtl">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" @click="closeTemplateModal"></div>
                                ...
                                <form @submit.prevent="submitTemplateForm" class="space-y-4">
                                    ...
                                    <div>
                                        <div class="mb-3" style="text-align: right !important;">
                                            <label for="template_name" class="text-sm font-medium text-gray-700" style="text-align: right !important; display: block;">
                                                اسم القالب *
                                            </label>
                                        </div>
                                        <input
                                    ...
                                    <div>
                                        <div class="mb-3" style="text-align: right !important;">
                                            <label for="template_category" class="text-sm font-medium text-gray-700" style="text-align: right !important; display: block;">
                                                الفئة *
                                            </label>
                                        </div>
                                        <select
                                    ...
                                    <div>
                                        <div class="mb-3" style="text-align: right !important;">
                                            <label for="template_thumbnail" class="text-sm font-medium text-gray-700" style="text-align: right !important; display: block;">
                                    ...
                                    <div>
                                        <div class="mb-3" style="text-align: right !important;">
                                            <label for="template_price" class="text-sm font-medium text-gray-700" style="text-align: right !important; display: block;">
