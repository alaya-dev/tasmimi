<template>
    ...
    <AdminLayoutSidebar>
        <template #breadcrumb>
            ...
            <span class="text-gray-500">إضافة قالب جديد</span>
        </template>
            ...
            <div class="flex justify-between items-center flex-row-reverse">
                <div class="flex items-center flex-row-reverse">
                    ...
                    <div class="text-right">
                        <h2 class="font-semibold text-xl text-gray-800 leading-tight">إضافة قالب جديد</h2>
                        <p class="mt-1 text-sm text-gray-600">إنشاء قالب جديد للبطاقات</p>
                    </div>
                </div>
            </div>
        </template>
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-4 text-right">
                        <h3 class="text-lg font-semibold text-white">معلومات القالب</h3>
                        <p class="text-blue-100 text-sm">أدخل تفاصيل القالب الجديد</p>
                    </div>
