<template>
    ...
    <AdminLayoutSidebar>
        ...
        <div v-if="showCreateModal || showEditModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true" dir="rtl">
                                ...
                                <form @submit.prevent="submitForm" class="space-y-4">
                                    ...
                                    <div>
                                        <div class="mb-3" style="text-align: right !important;">
                                            <label for="modal_name" class="text-sm font-medium text-gray-700" style="text-align: right !important; display: block;">
                                                اسم الفئة
                                            </label>
                                        </div>
                                        <input
