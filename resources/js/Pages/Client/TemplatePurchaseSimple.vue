    ...
    <div class="min-h-screen bg-gray-50 py-12">
        <div class="max-w-md mx-auto">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="mb-6">
                    <img 
                        :src="template.image_url || '/images/template-placeholder.jpg'" 
                        :alt="template.name"
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="font-semibold">{{ template.category?.name || 'غير محدد' }}</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">السعر:</span>
                        <span class="font-bold text-lg text-green-600">{{ template.price }} ريال</span>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <a
                        :href="route('client.templates.purchase.moyasar', template.id)"
                        :class="[
                    ...
                    >
                        ...
                        <span v-else class="flex items-center justify-center">
                            ...
                            اشتري الآن بـ {{ template.price }} ريال
                        </span>
                    </a>
                </div>
