            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-lg shadow mb-6">
                    <div class="p-6">
                        ...
                        <form @submit.prevent="applyFilters" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <!-- Buttons -->
                            <div class="md:col-span-2 lg:col-span-4 flex space-x-2 space-x-reverse">
                                <button
                                    type="submit"
                ...
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div v-if="invoices.data.length === 0" class="text-center py-12">
                        ...
                        <p class="text-gray-600">لم يتم العثور على أي فواتير بالمعايير المحددة</p>
                    </div>
...
const applyFilters = () => {
    router.get(route('client.invoices.index'), filterForm, {
        preserveState: true,
        preserveScroll: true
    });
};
