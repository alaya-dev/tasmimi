        ...
        <nav class="bg-white shadow">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div :class="isRTL ? 'flex-row-reverse' : 'flex'" class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <div :class="isRTL ? 'me-3' : 'ml-3'" class="relative">
                                ...
                                <template #trigger>
                                    <span class="inline-flex rounded-md">
                                        ...
                                        >
                                            ...
                                            <svg
                                                :class="isRTL ? 'me-2 -ms-0.5' : 'ml-2 -mr-0.5'"
                                                class="h-4 w-4"
            ...
            >
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <ResponsiveNavLink :href="route('admin.invoices.index')" :active="route().current('admin.invoices.*')">
                        الفواتير
                    </ResponsiveNavLink>
                </div>
